...
echo "${CYAN_TEXT}${BOLD_TEXT}             GDGOC IIMT CREW  Tutorials                   ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}🙏 Special thanks to Kunal Singh for this tutorial!${RESET_FORMAT}"
echo "${GREEN}${BOLD}Thank you for using GDGOC IIMT CREW!!${RESET}"
echo
echo "${YELLOW}For more cloud tutorials and labs, visit:${RESET}"
echo "${CYAN}https://https://youtube.com/@gdgociimt?si=vjMXKxm51CLLfqSH${RESET}"
